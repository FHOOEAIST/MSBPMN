...
/**
 * <p>Test class for {@link StartEventCondition}</p>
 *
 * @author Andreas Pointner
 */

public class StartEventConditionTest {

    private final StartEventCondition condition = new StartEventCondition();

    @Test
    public void testConditionPositive() {
        // given
        Vertex<PlanDefinition.PlanDefinitionActionComponent, Void> vertex = new VertexImpl<>(null);
        vertex.addMetaTag(new MetaTagImpl<>(TransformationConstants.START_META_TAG, true));
