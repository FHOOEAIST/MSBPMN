...
/**
 * <p>Test class for {@link ExclusiveGatewayCondition}</p>
 *
 * @author Andreas Pointner
 */
public class ExclusiveGatewayConditionTest {
    private final ExclusiveGatewayCondition condition = new ExclusiveGatewayCondition();
    ...
    public void testConditionPositive2() {
        ...
        PlanDefinition.PlanDefinitionActionComponent action = new PlanDefinition.PlanDefinitionActionComponent();
        action.setGroupingBehavior(PlanDefinition.ActionGroupingBehavior.LOGICALGROUP);
        action.setSelectionBehavior(PlanDefinition.ActionSelectionBehavior.EXACTLYONE);
    ...
    @Test
    public void testConditionPositive3() {
        // given
    ...
    @Test
    public void testConditionPositive4() {
        // given
        PlanDefinition.PlanDefinitionActionComponent join = new PlanDefinition.PlanDefinitionActionComponent();
        PlanDefinition.PlanDefinitionActionComponent action = new PlanDefinition.PlanDefinitionActionComponent();
        action.setGroupingBehavior(PlanDefinition.ActionGroupingBehavior.LOGICALGROUP);
