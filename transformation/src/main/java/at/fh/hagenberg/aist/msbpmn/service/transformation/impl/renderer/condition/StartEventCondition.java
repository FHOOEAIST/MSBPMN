...
/**
 * <p>The condition to check if an ActionComponent is an start event</p>
 *
 * @author Andreas Schuler
 * @author Andreas Pointner
 */
@Component
public class StartEventCondition implements RendererCondition<Vertex<PlanDefinition.PlanDefinitionActionComponent, Void>> {

    private final Predicate<Vertex<PlanDefinition.PlanDefinitionActionComponent, Void>> condition =
            element -> element.getMetaTags().stream().anyMatch(meta -> meta.getKey().equals(TransformationConstants.START_META_TAG));
