...
package at.fh.hagenberg.aist.msbpmn.service.configuration;

import at.fh.hagenberg.aist.msbpmn.service.transformation.impl.BpmnDocumentRootToStringTransformer;
import at.fh.hagenberg.aist.msbpmn.service.transformation.impl.BpmnGraphTransformer;
import at.fh.hagenberg.aist.msbpmn.service.transformation.impl.EdgeType;
import at.fh.hagenberg.aist.msbpmn.service.transformation.impl.PlanDefinitionToGraphTransformer;
import at.fh.hagenberg.aist.msbpmn.service.transformation.impl.renderer.*;
import at.fh.hagenberg.aist.msbpmn.service.transformation.impl.renderer.backboneprocessors.*;
import at.fh.hagenberg.aist.msbpmn.service.transformation.impl.renderer.condition.ConditionalEventCondition;
import at.fh.hagenberg.aist.msbpmn.service.transformation.impl.renderer.condition.StartConditionalEventCondition;
import at.fh.hagenberg.aist.msbpmn.service.transformation.impl.renderer.condition.TimedEventCondition;
import at.fh.hagenberg.aist.msbpmn.service.transformation.impl.renderer.condition.TimedStartEventCondition;
import at.fh.hagenberg.aist.msbpmn.service.transformation.renderer.MultiConditionalGraphTransformationRenderer;
 ...
 */
@Configuration
@ComponentScan("at.fh.hagenberg.aist.msbpmn.service")
public class TransformationConfiguration {
    ...
    public BiConsumer<Edge<?, Void>, EdgeType> edgeTypeConsumer() {
        return (e, t) -> e.addMetaTag(graphFactory().createMetaTag(EDGE_TYPE_META_TAG, t));
    }
