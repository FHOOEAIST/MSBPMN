...
# Timed Start Duration

In this section the transformation from Fhir->BPMN for an timed start duration is shown.
...
<script type="text/javascript" src="../js/fhir2bpmn/timedStartDuration.js"></script>
...
<definitions xmlns="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:ns2="http://www.omg.org/spec/DD/20100524/DI" xmlns:ns3="http://www.omg.org/spec/DD/20100524/DC" xmlns:ns4="http://www.omg.org/spec/BPMN/20100524/DI" targetNamespace="http://aist.fh-hagenberg.at/msbpmn">
    <process isExecutable="false" name="Process_udi71uawbq" id="Process_udi71uawbq">
        <startEvent isInterrupting="false" parallelMultiple="false" name="Task 1" id="id_start10">
            <outgoing>sf_start10_ad_1_triggerAction</outgoing>
            <timerEventDefinition id="sampleTriggerDef">
                <timeDuration id="sampleTriggerDef_timeDuration">P10S</timeDuration>
            </timerEventDefinition>
        </startEvent>
        <sequenceFlow sourceRef="id_start10" targetRef="id_ad_1_triggerAction" id="sf_start10_ad_1_triggerAction"/>
        <userTask name="Task 1" id="id_ad_1_triggerAction">
            <incoming>sf_start10_ad_1_triggerAction</incoming>
        ...
        <userTask name="Task 3" id="id_ad_3">
            ...
            <outgoing>sf_ad_3_end9</outgoing>
        </userTask>
        <sequenceFlow sourceRef="id_ad_3" targetRef="id_end9" id="sf_ad_3_end9"/>
        <endEvent name="end" id="id_end9">
            <incoming>sf_ad_3_end9</incoming>
        </endEvent>
    </process>
    <ns4:BPMNDiagram>
        <ns4:BPMNPlane bpmnElement="Process_udi71uawbq">
            <ns4:BPMNShape bpmnElement="id_start10" isHorizontal="true" isExpanded="true">
            ...
            <ns4:BPMNShape bpmnElement="id_end9" isHorizontal="true" isExpanded="true">
            ...
            <ns4:BPMNEdge bpmnElement="sf_ad_3_end9">
                <ns2:waypoint x="540.0" y="100.0"/>
                <ns2:waypoint x="590.0" y="100.0"/>
            </ns4:BPMNEdge>
            <ns4:BPMNEdge bpmnElement="sf_start10_ad_1_triggerAction">
